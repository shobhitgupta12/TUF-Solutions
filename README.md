...
| 0004 | [Check if the i-th bit is Set or Not](./DSA/Bit-Manipulation/check-if-the-i-th-bit-is-set-or-not) | [PY](./DSA/Bit-Manipulation/check-if-the-i-th-bit-is-set-or-not/solution.py) | 🟢 Easy | `DSA` / `Bit-Manipulation` |
| 0005 | [Count all Digits of a Number](./DSA/Beginner-Problems/count-all-digits-of-a-number) | [PY](./DSA/Beginner-Problems/count-all-digits-of-a-number/solution.py) | 🟢 Easy | `DSA` / `Beginner-Problems` |
| 0006 | [Count the Number of Set Bits](./DSA/Bit-Manipulation/count-the-number-of-set-bits) | [PY](./DSA/Bit-Manipulation/count-the-number-of-set-bits/solution.py) | 🟢 Easy | `DSA` / `Bit-Manipulation` |
...
| 0021 | [Second Largest Element](./DSA/Arrays/second-largest-element) | [PY](./DSA/Arrays/second-largest-element/solution.py) | 🟢 Easy | `DSA` / `Arrays` |
